...
const { criarPagamento, getSessionId, getTransactionStatus, getNotification } = require("./integrations/pagseguro");
...
const QuantidadeValidation = require("./validations/quantidadeValidation");
